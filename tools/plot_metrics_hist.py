...
def parse_args():
    ...
    parser.add_argument(
        "--metrics_folder",
        type=str,
        default="results/dataset_metrics/",
        help="path to the folder with metrics csv files",
    )
    parser.add_argument(
        "--save_path",
        type=str,
        default="results/dataset_metrics_hists",
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="which metric to plot, separate by commas",
    )
...
if __name__ == "__main__":
    ...
    for metrics_csv_path in metrics_csv_paths:
        ...
        df = df.sort_values(by=sorting_criterion, ascending=False)
        df = df.transpose()
        ...
        if colors is None:
            ...
            colors = {
                model_names[idx]: colors_hex[idx] for idx in range(len(model_names))
            }
