...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="fast_tsne",
        help="embeddings projection method [fast_tsne, umap, tsne]",
    )
    parser.add_argument(
        "--n_labels",
        type=int,
        default=-1,
        help="number of labels to show, if value is less than 0 for example -5 script will visualize only labels with 5 or more samples",
    )
    parser.add_argument("--n_jobs", type=int, default=4, help="number of parallel jobs")
    parser.add_argument(
        "--interactive", action="store_true", help="use interactive visualization"
    )
