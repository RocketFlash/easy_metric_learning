...
def parse_args():
    ...
    parser.add_argument(
        "--work_dirs", type=str, default="work_dirs/test/", help="path to work_dirs"
    )
    parser.add_argument(
        "--csv_file_name",
        type=str,
        default="eval_result_on_retail.csv",
        ...
        if csv_file_path.is_file():
            ...
            for dataset_name, metrics in df.iterrows():
                for metric_name in metric_names:
                    all_datasets_metrics[dataset_name][run_name][metric_name] = metrics[
                        metric_name
                    ]
