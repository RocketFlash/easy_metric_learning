...
if __name__ == "__main__":
    ...
    if args.dataset_path:
        ...
        for image_path in tqdm(images_paths):
            sample = get_sample(str(image_path), img_h=img_size, img_w=img_size)
            with torch.no_grad():
                ...
                cos_sim = cosine_similarity(torch.from_numpy(o_s), o_t)
    ...
    if args.image_path:
        sample = get_sample(args.image_path, img_h=img_size, img_w=img_size)
