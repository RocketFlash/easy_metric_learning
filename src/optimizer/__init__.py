        ...
        params = [
            {
                ...
                * optimizer_config.backbone_lr_scaler,
            },
            {
                "params": model.embeddings_net.head.parameters(),
                "lr": optimizer_config.optimizer.lr,
            },
            {"params": model.margin.parameters(), "lr": optimizer_config.optimizer.lr},
        ]

    optimizer = hydra.utils.instantiate(
        optimizer_config.get("optimizer"), params=params, _convert_="object"
    )
