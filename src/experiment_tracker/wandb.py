...
class WandbTracker(ExperimentTracker):
    def __init__(self, config, config_dict):
        ...
        self.wandb_run = wandb.init(
            project=config.project_name, name=config.run_name, reinit=True
        )
