...
def save_batch_grid(
    ...
    inv_norm = get_inverse_transfrom(std=norm_std, mean=norm_mean)
    ...
    image_grid = torchvision.utils.make_grid(images, nrow=4, pad_value=0, padding=5)
...
class DatasetViewer:
    def __init__(self, dataset_path, dataset_info_csv):
    ...
    def random_batch(self, b):
        ...
        next_labels = np.random.choice(self.group_names, size=bs, replace=False)
