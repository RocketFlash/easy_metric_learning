...
def parse_args():
    ...
    parser.add_argument(
        "--dataset_csv", default="./", help="path to the dataset info file"
    )
    parser.add_argument(
        "--image_size", type=int, default=170, help="minimal image size"
    )
...
if __name__ == "__main__":
    ...
    resize_image_fn = functools.partial(
        resize_image,
    ...
    progress_bar = tqdm(
        pool.imap(resize_image_fn, images_paths), total=len(images_paths)
    )
