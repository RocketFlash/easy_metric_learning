...
def parse_args():
    ...
    parser.add_argument(
        "--dataset_csv", default="", help="path to the dataset info csv file"
    )
    parser.add_argument(
        "--desc_csv", default="", help="path to the descriptions csv file"
    )
...
if __name__ == "__main__":
    ...
    df_dataset = df_dataset.merge(
        df_info, how="inner", left_on="label", right_on="upc", validate="many_to_one"
    )
