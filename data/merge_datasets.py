...
def parse_args():
    ...
    parser.add_argument(
        "--dataset_1_info", default="./", help="path to the dataset1 info file"
    )
    parser.add_argument(
        "--dataset_2_info", default="./", help="path to the dataset2 info file"
    )
    ...
    parser.add_argument(
        "--threshold", type=int, default=5, help="threshold for duplicates selection"
    )
