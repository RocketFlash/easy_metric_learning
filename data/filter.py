...
def filter_max_n_samples_per_class(df, max_n_samples=50):
    good_dfs = []
    ...
    for label, label_group in tqdm(labels_groups):
        if len(label_group)<=max_n_samples:
            good_dfs.append(label_group)
...
def parse_args():
    ...
    parser.add_argument('--filter_info', default="./", help="path to the filter file")
...
if __name__ == '__main__':
    ...
    # dataset_info_df = duplicates_removal_filtering(dataset_info_df, threshold=5)
    # print('AFTER dedup')
    # print(dataset_info_df)

    # dataset_info_df = filter_min_n_samples_per_class(dataset_info_df, min_n_samples=5)
   
    # print('AFTER min_n_samples filtering')
    # print(dataset_info_df)

    # dataset_info_df = filter_max_n_samples_per_class(dataset_info_df, max_n_samples=50)
    # print('AFTER max_n_samples filtering')
    # print(dataset_info_df)
