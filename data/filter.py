...
def parse_args():
    ...
    parser.add_argument(
        "--max_n_samples", default=-1, type=int, help="max number of samples per class"
    )
...
if __name__ == "__main__":
    ...
    dataset_info_df.reset_index(inplace=True, drop=True)
    ...
    if args.max_n_samples > 0:
        ...
        dataset_info_df = undersampling(
            dataset_info_df, max_n_samples=args.max_n_samples
        )
