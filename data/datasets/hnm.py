...
class HNM(BaseDataset):
    ...
    def download(self):
        if not self.dataset_folder.is_dir():
            ...
            try:
                ...
                print(
                    "In order to download H&M dataset you must have kaggle account and generated kaggle.json file in ~/.kaggle/kaggle.json "
                )
    ...
    def prepare(self):
        ...
        df_info = df_info.rename(
            columns={"article_id": "label", "detail_desc": "title"}
        )
