...
class Shopee(BaseDataset):
    ...
    def download(self):
        if not self.dataset_folder.is_dir():
            ...
            try:
                ...
                print(
                    "In order to download Shopee dataset you must have kaggle account and generated kaggle.json file in ~/.kaggle/kaggle.json "
                )
    ...
    def prepare(self):
        ...
        df_info = df_info[
            ["file_name", "label", "title", "width", "height", "is_test", "hash"]
        ]
