...
def parse_args():
    parser = argparse.ArgumentParser(
        description="prepare dataset for testing using csv"
    )
    parser.add_argument(
        "--dataset_csv", default="./", help="path to the csv file describing dataset"
    )
...
if __name__ == "__main__":
    ...
    df = pd.read_csv(
        DATASET_CSV, dtype={"label": str, "file_name": str, "width": int, "height": int}
    )
