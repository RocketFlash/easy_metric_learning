...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--gt_embeddings_file", type=str, default="", help="path to embeddings file"
    )
    parser.add_argument("--gt_dataset_path", type=str, default="", help="dataset path")
    parser.add_argument(
        "--embeddings_file", type=str, default="", help="path to embeddings file"
    )
    ...
    for l in tqdm(intersect_labels):
        ...
        if f_names_i.shape[0] > 0:
            ...
            gt_images_i = [
                get_image(gt_dataset_path / f_name) for f_name in gt_f_names_i
            ]
            ...
            plot_embeddings(
                embgs, lbls, method="tsne", save_path=save_path / f"{l}_tsne.png"
            )
