...
python tools/test.py\
        ...
        model_type=torch\
        evaluation/data=$DATASET_NAME\
        weights=work_dirs/train/arcface_openclip-ViT-B32_laion2b_no_head_retail_full_img224x224_emb512/last_emb.pt\
        embeddings_size=512\
        img_h=224\
        img_w=224\
        run_name="$DATASET_NAME"_openclip_vit_b32_img224x224_emb512_trained_on_retail_full
...
echo "test trained openclip vit b16 with head on $DATASET_NAME datasets"
python tools/test.py\
        backbone=openclip_vit_b16\
        head=no_head\
        embeddings_size=512\
        ...
        img_h=224\
        img_w=224\
        weights=work_dirs/train/arcface_openclip-ViT-B16_laion2b_no_head_retail_full_img224x224_emb512/last_emb.pt\
        run_name="$DATASET_NAME"_openclip_vit_b16_img224x224_emb512_trained_on_retail_full
